...
"""
Pools the output from the generator so we can sample later to train the discriminator
"""
class HistoryBuffer:
    ...
    def _make_space(self, max_del_size):
        # Need to continuously update the buffer
    ...
    def randomise_existing_batch(self, existing_batch):
        ...
        # It is randomised if we actually swap out images in the batch
